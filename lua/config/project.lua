...
function M.add_project()
    local project_root = require("config.utils").find_project_root(vim.uv.cwd(), M.config.project_markers, { ignore_submodules = true })
        ...
        actions = {
            confirm = function(picker)
                ...
                if item then
                    ...
                    local git_root = require("config.utils").find_project_root(project_dir, { ".git" }, { ignore_submodules = true })
